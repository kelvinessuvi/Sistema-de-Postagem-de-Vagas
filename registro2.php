                ...
                <div class="container clearfix">
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
                        <ul class="nav navbar-nav">
							...
							<li>
								<a href="#">para candidatos <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
									<li><a href="vagas.php" class="dez-page">Procurar emprego</a></li>
									<li><a href="empresas.php" class="dez-page">Empresas</a></li>
							...
							<li>
								...
								<ul class="sub-menu">
									<li><a href="sobre.php" class="dez-page">Sobre nós</a></li>
									
									</li>
									<li><a href="login.php" class="dez-page">Login</a></li>
									<li><a href="registro.php" class="dez-page">Registrar</a></li>
									<li><a href="contactos.php" class="dez-page">Contactenos</a></li>
								</ul>
							</li>
						</ul>			
                    </div>
        ...
        <div class="dez-bnr-inr overlay-black-dark" style="background-image:url(images/banner/bnr1.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Entregar o currículo</h1>
					<div class="breadcrumb-row">
						<ul class="list-inline">
							<li><a href="#">Início</a></li>
							<li>Entregar o currículo</li>
						</ul>
					</div>
                </div>
            </div>
			...
			<div class="section-full bg-white submit-resume content-inner-2">
				<div class="container">
					<form>
						...
						<div class="form-group">
							<label>título proficional</label>
							<input type="text" class="form-control" placeholder="arquiteto">
						</div>
						...
						<div class="form-group">
							...
							<textarea class="form-control" placeholder="Sua Descriçâo"></textarea>
						</div>
						<div class="form-group">
							<label>Hablidades (optional)</label>
							<input type="text" class="form-control" placeholder="Suas Hablidades">
						</div>
						<button type="submit" class="site-button">Enviar</button>
					</form>
				</div>
			</div>
		</div>
            ...
            <div class="container">
                <div class="row">
								...
								<form class="dzSubscribe" action="http://job-board.w3itexperts.com/xhtml/script/mailchamp.php" method="post">
									...
									<div class="input-group">
										...
										<span class="input-group-btn">
											<button name="submit" value="Submit" type="submit" class="site-button radius-xl">Subscrever</button>
										</span> 
									</div>
								</form>
							</div>
					...
					<div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-12">
                        <div class="widget border-0">
                            <h5 class="m-b30 text-white">Econtre emprego</h5>
