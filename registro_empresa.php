<?php
	...
	if(isset($_POST['nomeempresa'],$_POST['email'],$_POST['morada'],$_POST['nif'],$_POST['telefone'],$_POST['senha'])){
		...
		$sql = "INSERT INTO empresa (nome_empresa,morada_empresa,logotipo,email_empresa,telefone_empresa,senha,dataadd_empresa,estado_empresa) values (?,?,?,?,?,?,?,?)";
		$stmt = $pdo->prepare($sql);
		$stmt->execute([$nome,$morada,$imgname,$email,$telefone,$senha,$data,$estado]);
		echo "
			<script>
				alert('Aguarde para fazer login enquanto verficamos a sua empresa.');
			</script>
        ...
        <div class="section-full content-inner shop-account">
                ...
                <div class="row">
					<div class="col-md-12 text-center">
						<h3 class="font-weight-700 m-t0 m-b20">CADASTRAR EMPRESA</h3>
					</div>
				</div>
                <div class="row">
							...
							<div class="tab-content">
								<form method="POST" id="login" class="tab-pane active">
									<div class="form-group">
										...
										<input name="nomeempresa" class="form-control" placeholder="Nome" type="text">
									</div>
									<div>
										<label>Morada</label>
									...
									<div class="form-group">
										...
										<input type="tel" class="form-control" name="telefone" placeholder="Insira o seu nº de telemóvel">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="font-weight-700">NIF *</label>
										<input name="nif" required class="form-control" placeholder="NIF " type="text">
									</div>
									<div class="form-group">
										<label class="font-weight-700">LOGOTIPO *</label>
										<input name="logotipo" required class="form-control" type="file">
									</div>
									<div class="form-group">
